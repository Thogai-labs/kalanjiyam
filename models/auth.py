...
from kalanjiyam.utils.user_mixins import KalanjiyamUserMixin


class User(KalanjiyamUserMixin, Base):
    """A user."""
...
class Role(Base):
    ...
    Roles are how we model fine-grained permissions on Kalanjiyam.
    """
