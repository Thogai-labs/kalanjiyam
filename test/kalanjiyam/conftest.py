...
from kalanjiyam.consts import BOT_USERNAME, TEXT_CATEGORIES
from kalanjiyam.queries import get_engine, get_session
from kalanjiyam.seed.lookup import page_status as page_status_seeding
from kalanjiyam.seed.lookup import role as role_seeding
...
def initialize_test_db():
    ...
    project = db.Project(
        slug="test-project", display_title="Test Project", board_id=board.id, is_publicly_viewable=True
    )
    session.add(project)
    session.flush()
