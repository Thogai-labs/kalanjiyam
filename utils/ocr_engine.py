...
class NanonetsOcrEngine(OcrEngine):
    ...
    def _get_engine_instance(self):
        ...
        if self._engine_instance is None:
            ...
            self._engine_instance = NanonetsEngine()
...
class DeepSeekOcrEngine(OcrEngine):
    ...
    def _get_engine_instance(self):
        ...
        if self._engine_instance is None:
            ...
            self._engine_instance = DeepSeekEngine()
        return self._engine_instance
...
class ChandraOcrEngine(OcrEngine):
    ...
    def _get_engine_instance(self):
        ...
        if self._engine_instance is None:
            ...
            self._engine_instance = ChandraEngine()
        return self._engine_instance
...
class Qwen3OcrEngine(OcrEngine):
    ...
    def _get_engine_instance(self):
        ...
        if self._engine_instance is None:
            ...
            self._engine_instance = Qwen3Engine()
        return self._engine_instance
...
class OcrEngineFactory:
    ...
    def create(cls, engine_name: str) -> OcrEngine:
        ...
        :raises: RuntimeError if engine is not installed
        """
